...
const parseAppContextAck = replyParser<RuntimeAppContextResponse>("app_context_ack");
const parseTeleopAck = replyParser<RuntimeTeleopCommandResponse>("teleop_ack");
const parseTopicSubscriptionAck = replyParser<RuntimeTopicSubscriptionResponse>("subscription_ack");
const parseTopicUnsubscriptionAck = replyParser<RuntimeTopicUnsubscriptionResponse>("unsubscription_ack");
const parseTopicSample = replyParser<RuntimeTopicSampleMessage>(
  "topic_sample",
