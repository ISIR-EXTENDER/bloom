...
const GLOSSARY: Record<string, { es: string; fr: string }> = {
  ...
  // Visual servoing app (2026-09-24); "Visual servoing" keeps its name.
  "Gripper camera": { es: "Cámara de la pinza", fr: "Caméra de la pince" },
  "Save tag as target": { es: "Guardar la etiqueta como objetivo", fr: "Enregistrer le tag comme cible" },
  "Save this view": { es: "Guardar esta vista", fr: "Enregistrer cette vue" },
  "Tag detections": { es: "Detecciones de etiquetas", fr: "Détections de tags" },
  "Servo output": { es: "Salida del servo", fr: "Sortie du servo" },
  "Servo velocity": { es: "Velocidad del servo", fr: "Vitesse du servo" },
  Sideways: { es: "Lateral", fr: "Latéral" },
  Approach: { es: "Aproximación", fr: "Approche" },
  Servo: { es: "Servo", fr: "Servo" },
  Monitor: { es: "Monitor", fr: "Moniteur" },
